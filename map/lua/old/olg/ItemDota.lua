...
ItemDota = {Items={},Prefix={},TuBiao = {},Fixed = {}}  
...
function ItemDota:Int() 
    ...
    "锤","普通", "碎石者","ReplaceableTextures\\CommandButtons\\BTNOrcMeleeUpThree.blp","|cffff8080这把长柄锤贯穿了两名敌军的身体和他们身后的坚固城门。|r ")
    ...
    "饰品","普通", "轮回之蛇","tb","|cffff8080 万千能量皆流转于永恒之源，亦终将汇流于永恒之源。 |r")
     ...
     --for i= 1 ,30 do
         --self.Fixed[1][i] = {}
         --setmetatable(self.Fixed[1][i],Item) 
     --end
     --self.Fixed[1][1]:SetValue(4, 4, 4,25,HuJia,YiDongSuDu,0.3, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing,"A", 
     --"斧","普通", "布里奇堡绞肉机","tb","|cffff8080布里奇堡被誉为绞肉机和红河之地，地理位置重要，经常发生会战，于是出现了一本名为布里奇堡绞肉机的厌战小说，故事主人公手持一把锯齿剑，名为绞肉机。|r ")

     --self.Fixed[1][2]:SetValue(0, 0, 15,20,HuJia,YiDongSuDu,0.3, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,0.15, MoFaKangXing,"A", 
     --"法杖","普通", "大法师权杖","tb","|cffff8080让我来告诉你一个秘密吧，年轻人，权杖上的宝石其实是上帝之心阿里艾丽Aliery的一小块碎片……梅林下令制作这个权杖是为了纪念被同学死灵术士泰德Ted残忍杀害的导师大魔法师阿尔瓦Alva|r  ")

     --self.Fixed[1][3]:SetValue(0, 0, 15,20,HuJia,YiDongSuDu,0.3, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing,"A", 
     --"法杖","普通", "灵魂触摸者","tb","|cffff8080让我来告诉你一个秘密吧，年轻人，权杖上的宝石其实是上帝之心阿里艾丽Aliery的一小块碎片……梅林下令制作这个权杖是为了纪念被同学死灵术士泰德Ted残忍杀害的导师大魔法师阿尔瓦Alva|r ")

     --self.Fixed[1][4]:SetValue(Liliang, ZhiHui, MinJie,25,HuJia,YiDongSuDu,0.3, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing,"A", 
     --"法杖","普通", "阿迪斯短杖","tb","|cffff8080让我来告诉你一个秘密吧，年轻人，权杖上的宝石其实是上帝之心阿里艾丽Aliery的一小块碎片……梅林下令制作这个权杖是为了纪念被同学死灵术士泰德Ted残忍杀害的导师大魔法师阿尔瓦Alva|r  ")

     --self.Fixed[1][5]:SetValue(Liliang, ZhiHui, MinJie,25,HuJia,YiDongSuDu,0.3, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing,"A", 
     --"法杖","普通", "韦林的狂信法杖","tb","|cffff8080著名的炼金术士韦林的杰作。|r")

    -- self.Fixed[1][6]:SetValue(Liliang, ZhiHui, MinJie,25,HuJia,YiDongSuDu,0.3, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing,"A", 
     --"弓","普通", "破风的圆舞曲","tb","|cffff8080这是一把传奇的弓，却被巧妙的工匠墨菲格林改造成了一把风琴，但仍然不失原有的力量。|r ")

     --self.Fixed[1][1]:SetValue(Liliang, ZhiHui, MinJie,25,HuJia,YiDongSuDu,0.3, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing,"A", 
     --"斧","普通", "布里奇堡绞肉机","tb","|cffff8080布里奇堡被誉为绞肉机和红河之地，地理位置重要，经常发生会战，于是出现了一持一把锯齿剑，名为绞肉机。|r ")
