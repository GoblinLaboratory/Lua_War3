...
require "Equipment"
    ...
    --9披风
    --10饰品
--EquipmentDota = {Dota1={},Dota2={},Dota3={},Dota4={},Dota5={},Dota6={},Dota7={},Dota8={},Dota9={},Dota10={},Dota11={}}  
-- 装备类
...
EquipmentDota = {Items={},Prefix={},TuBiao = {}}  

function EquipmentDota:new(o)  
    o = o or {}  
    setmetatable(o,self)  
    self.__index = self  
...
function EquipmentDota:Instance()  
...
function EquipmentDota:Int() 
    --Equipment:new (ll,zh,mj,gj,hj,yd,gs,sm,smsx,smhf,mf,mfsx,mfhf,zdy,ty,pz,na,tb,ex)
    --ll,zh,mj,gj,hj,yd,gs,smsx,smhf,mfsx,mfhf,zdy,ty,pz,na,tb,ex
    --(Liliang, ZhiHui, MinJie,GongJi,HuJia,YiDongSuDu,GongJiSuDu, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, ZiDingYi, Types,PinZhi, Name,TuBiao, Explain)
    --self.Items[1][1]:SetValue(Liliang, ZhiHui, MinJie,GongJi,HuJia,YiDongSuDu,GongJiSuDu, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, ZiDingYi, 
    ...
    for i= 1 ,26 do
        self.Prefix[1][i]  = {}
        setmetatable(self.Prefix[1][i],Equipment) 
    end
    
    self.Prefix[1][1]:SetValue(Liliang, ZhiHui, MinJie,5,HuJia,YiDongSuDu,GongJiSuDu, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu,MoFaKangXing, 1, 
    ...
    --self.Prefix[1][2]:SetValue(Liliang, ZhiHui, MinJie,GongJi,HuJia,YiDongSuDu,GongJiSuDu, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing,1, 
   -- Types,"普通", Name,"tb", Explain)
    ...
    for i= 1 ,30 do
        self.Items[1][i] = {}
        setmetatable(self.Items[1][i],Equipment) 
    end
    ...
    "弓","普通", "闪光","tb", "|cffff8080魔剑士伊萨诺克Ezranoak是Micious魔剑士团的团长，也是唯一可以与亚历克斯Alex抗衡的魔剑士。伊萨诺克喜欢使用造型奇特的弓，优雅而华丽地击败对手。|r ")
     --self.Items[1][1]:SetValue(Liliang, ZhiHui, MinJie,GongJi,HuJia,YiDongSuDu,GongJiSuDu, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing, "A", 
    --Types,"普通", Name,"tb", Explain)
...
--副手装备
    ...
    for i= 1 ,30 do
        self.Items[2][i] = {}
        setmetatable(self.Items[2][i],Equipment) 
    end
    ...
    --self.Items[2][1]:SetValue(Liliang, ZhiHui, MinJie,GongJi,HuJia,YiDongSuDu,GongJiSuDu, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing, "B", 
    --Types,"普通", Name,"tb", Explain)
    ...
    for i= 1 ,30 do
        self.Items[3][i] = {}
        setmetatable(self.Items[3][i],Equipment) 
    end
    ...
    --self.Items[3][1]:SetValue(Liliang, ZhiHui, MinJie,GongJi,HuJia,YiDongSuDu,GongJiSuDu, ShengMingShangXian,ShengMingHuiFu,MoFaShangXian,MoFaHuiFu, MoFaKangXing,"C", 
    --Types,"普通", Name,"tb", Explain)
     ...
     for i= 1 ,30 do
         self.Items[4][i] = {}
         setmetatable(self.Items[4][i],Equipment) 
     end
    ...
    for i= 1 ,30 do
        self.Items[5][i] = {}
        setmetatable(self.Items[5][i],Equipment) 
    end
    ...
    for i= 1 ,30 do
        self.Items[6][i] = {}
        setmetatable(self.Items[6][i],Equipment) 
    end
    ...
    for i= 1 ,30 do
        self.Items[7][i] = {}
        setmetatable(self.Items[7][i],Equipment) 
    end
    ...
    for i= 1 ,30 do
        self.Items[8][i] = {}
        setmetatable(self.Items[8][i],Equipment) 
    end
    ...
    for i= 1 ,30 do
        self.Items[9][i] = {}
        setmetatable(self.Items[9][i],Equipment) 
    end
    ...
    for i= 1 ,30 do
        self.Items[10][i] = {}
        setmetatable(self.Items[10][i],Equipment) 
    end
    ...
    for i= 1 ,30 do
        self.Items[11][i] = {}
        setmetatable(self.Items[11][i],Equipment) 
    end
...
--si = EquipmentDota:new()  
--si:Int()

--for i= 1 ,26 do
    --print(si.Items[1][i].Name)
    --print(si.Items[1][i].Explain)
--end
--for i= 1 ,9 do
    --print(si.Items[2][i].Name)
    --print(si.Items[2][i].Explain)
--end
