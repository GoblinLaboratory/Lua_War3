...
CJ.TriggerAddCondition(trig_RemoveEquipment, CJ.Condition(
    function ()
        ...
        BJ.GetIssuedOrderIdBJ() == BJ.String2OrderIdBJ("parasiteoff") or--头盔 C
        BJ.GetIssuedOrderIdBJ() == BJ.String2OrderIdBJ("parasiteon") or --铠甲 D
        BJ.GetIssuedOrderIdBJ() == BJ.String2OrderIdBJ("polymorph") or --披风 E
        BJ.GetIssuedOrderIdBJ() == BJ.String2OrderIdBJ("possession") or--手套 F
        BJ.GetIssuedOrderIdBJ() == BJ.String2OrderIdBJ("preservation") or--鞋 G
        BJ.GetIssuedOrderIdBJ() == BJ.String2OrderIdBJ("purge")  or--面具 H
        BJ.GetIssuedOrderIdBJ() == BJ.String2OrderIdBJ("rainofchaos") or--项链 I
        BJ.GetIssuedOrderIdBJ() == BJ.String2OrderIdBJ("rainoffire") or--饰品 J
        BJ.GetIssuedOrderIdBJ() == BJ.String2OrderIdBJ("raisedead") -- 戒指 K      
    end
))
CJ.TriggerAddAction(trig_RemoveEquipment,
    function () 
        ...
        if( zdy ~= "L" ) then
            ...
            local xd = GM:GetHero(id):GetEquipment(zdy)--获取已装备的物品数据
			local xc = s1:CreateAppointItem(xd)--创建物品数据
            local j = "ZG"..zdy..tostring(id-1)
            --删除工程升级
            CJ.UnitRemoveAbility(u, s1:GetId(j) )
